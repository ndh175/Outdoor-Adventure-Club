<div class="highlight-phone" style="background-color:rgb(255,255,255);">
    <div class="container">
        <div class="row" style="background-color:rgb(38,38,38);padding:25px;border-radius:10px;">
            <div class="col-md-7"><img class="img-rounded img-responsive" src="{{ asset('/storage/' . substr($trip->image_url, 7)) }}" style="width:1080px;height:1920px;object-fit:cover;overflow:hidden;"></div>
